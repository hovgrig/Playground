...
namespace XmlRpc {
  ...
  protected:
    ...
    static void generateResponseImpl(std::string const& resultXml, std::string& response);
    void generateResponse(std::string const& resultXml);
    static void generateFaultResponseImpl(std::string const& msg, std::string& response, int errorCode = -1);
    void generateFaultResponse(std::string const& msg, int errorCode = -1);
    static std::string generateHeader(std::string const& body);
